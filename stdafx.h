...
namespace Matrix4x4
{
	...
	inline XMFLOAT4X4 OrthoLH(float width, float heihgt, float NearZ, float FarZ)
	{
		XMFLOAT4X4 xmmtx4x4Result;
		XMStoreFloat4x4(&xmmtx4x4Result, XMMatrixOrthographicLH(width, heihgt, NearZ, FarZ));
		return(xmmtx4x4Result);
	}
