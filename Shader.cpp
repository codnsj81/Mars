...
void CBillboardObjectsShader::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
	...
	for (int i = 0;  i<m_nInstances ; i++)
	{
		...
		xPosition = 340 + rand() % 150;
		zPosition = 290 + rand() % 150;
...
void CDiffuseVertexShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
